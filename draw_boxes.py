...
from yamlparser.yamlparser import parseOrganization
...
def organization_units(filename: str):
    ous = parseOrganization(filename)
    doc = Document()
    doc.go_to_page(4)
...
if __name__ == '__main__':
    ...
    # organization_units(
    #     r"C:\Users\ingo\Development\python\LibreOffice\Resources\example.yaml")
    organization_units(r"C:\Users\ingo\Development\python\LibreOffice\Resources\organization_chart.yaml")
